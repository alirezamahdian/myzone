...
package utils.peer.stun.header;
...
import utils.peer.stun.util.Utility;
...
public class MessageHeader implements MessageHeaderInterface {
	...
	public static MessageHeader parseHeader(byte[] data) throws MessageHeaderParsingException {
		try {
			...
			switch (type) {
				case BINDINGREQUEST: mh.setType(MessageHeaderType.BindingRequest); break;
				case BINDINGRESPONSE: mh.setType(MessageHeaderType.BindingResponse); break;
				case BINDINGERRORRESPONSE: mh.setType(MessageHeaderType.BindingErrorResponse); break;
				case SHAREDSECRETREQUEST: mh.setType(MessageHeaderType.SharedSecretRequest); break;
				case SHAREDSECRETRESPONSE: mh.setType(MessageHeaderType.SharedSecretResponse); break;
				case SHAREDSECRETERRORRESPONSE: mh.setType(MessageHeaderType.SharedSecretErrorResponse); break;
