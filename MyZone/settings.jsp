...
if (request.getParameter("op") != null && request.getParameter("op").equals("createNewUser")){
    if (request.getParameter("username") != null && !request.getParameter("username").equals("") && request.getParameter("username").contains("@") && request.getParameter("username").contains(".")){
        mainSettings.createNewUser(request.getParameter("username"));
        if (!mainSettings.CAKeyFound){
            response.sendRedirect("settings.jsp?settings=basic&select=CAKey");
        }
    }else{
        response.sendRedirect("settings.jsp?show=createNewUser&error=true");
    }
            ...
            if (request.getParameter("select").equals("CAKey")){
                ...
                if (request.getParameter("select").equals("MyCert")){
                    if (request.getParameter("promptError") != null && request.getParameter("promptError").equals("myCertNotFound")){
                        %>
                        <tr>
                        <td><h3>&nbsp;&nbsp;&nbsp;<font color=red>Your Certificate Was not Found: </font></h3></td>
                        <td></td>
                        </tr>
                        <%
                    }
                    if (request.getParameter("promptError") != null && request.getParameter("promptError").equals("myCertCorrupted")){
                        %>
                        <tr>
                        <td><h3>&nbsp;&nbsp;&nbsp;<font color=red>Your Certificate Was Corrupted: </font></h3></td>
                        <td></td>
                        </tr>
                        <%
                    }
                ...
                if(request.getParameter("maxNumberOfChanges") != null){
                    if(request.getParameter("maxNumberOfChanges").equals("") || Integer.parseInt(request.getParameter("maxNumberOfChanges")) < 100 || Integer.parseInt(request.getParameter("maxNumberOfChanges")) > 1000){
                ...
                if(request.getParameter("MyZonePort") != null){
                    if(request.getParameter("MyZonePort").equals("") || Integer.parseInt(request.getParameter("MyZonePort")) < 0 || Integer.parseInt(request.getParameter("MyZonePort")) > 65535){
                ...
                if (maxNumberOfChangesError){
                    %><td><font
                    color=red>(Please enter a number between 100 and
                               1000)</font></td>
                    <%
                }
                %>
                ...
                value='<%=mainSettings.maxNumberOfChanges%>' /><h3>*Should be at a number between 100 and 1000 </h3></td>
                </tr>
                <td>&nbsp;</td>
                <tr>
                ...
                <% if (MyZonePortError){
                    %><td><font
                    color=red>(Please enter a valid port number)</font></td>
                    <%
                }%>
